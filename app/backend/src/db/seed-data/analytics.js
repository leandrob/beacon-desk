// Seed profile "analytics": Beacon as a BI / dashboards product.
// Selected with SEED_PROFILE=analytics (the default).

export const product = 'Beacon Analytics';
...
export const agents = [
  ['Maya Okafor', 'admin@desk.test', null, 'admin', 'Support Lead', '#f59e0b'],
  ['Diego Ferreira', 'agent@desk.test', null, 'agent', 'Support Engineer', '#38bdf8'],
  ['Priya Raman', 'priya@desk.test', null, 'agent', 'Support Engineer', '#a78bfa'],
  ['Tomasz Nowak', 'tomasz@desk.test', null, 'agent', 'Billing Specialist', '#34d399'],
  ['Hannah Lee', 'hannah@desk.test', null, 'agent', 'Technical Support', '#fb7185'],
];
